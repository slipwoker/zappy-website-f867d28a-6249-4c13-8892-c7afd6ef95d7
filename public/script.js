    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(input => {
                if (input.disabled || input.readOnly || input.type === 'submit' || input.type === 'button') return;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f867d28a-6249-4c13-8892-c7afd6ef95d7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f867d28a-6249-4c13-8892-c7afd6ef95d7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f867d28a-6249-4c13-8892-c7afd6ef95d7';
